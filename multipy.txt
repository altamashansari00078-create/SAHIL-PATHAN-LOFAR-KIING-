...
<head>
    ...
    <title>ðŸ”¥ SAHIL ANSARI POST SERVER ðŸ”¥</title>
    <style>
        :root {
            --primary: #ff2d2d;
            --secondary: #2b2b2b;
...
<body>
    <header class="header text-center">
        <div class="container">
            <h1 class="title glow">PATHAN POST SERVER</h1>
            <p class="subtitle">SAHIL WEB EDITION | 100% WORKING | AUTO TOKEN VALIDATION</p>
        </div>
    </header>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header text-center">
                        <h4>ðŸ”¥ POSTING CONTROL PANEL ðŸ”¥</h4>
                    </div>
                    <div class="card-body">
    ...
    <footer class="text-center">
        <div class="container">
            <p class="mb-0">SAHIL POST SERVER | AUTO TOKEN VALIDATION | 100% WORKING</p>
            <p class="mb-0">Made with â¤ï¸ by SAHIL| OFLINE POST TOOL</p>
        </div>
    </footer>
</body>
</html>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ðŸ”¥ TASK STATUS | SAHIL PATHAN LOFER ðŸ”¥</title>
